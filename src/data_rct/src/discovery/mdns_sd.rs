...
// use crate::discovery::{Device, PeripheralDiscovery, ThreadCommunication};
...
//                 match message {
//                     ThreadCommunication::StartAdvertising => { self.advertise() }
//                     ThreadCommunication::StopAdvertising => { self.stop_advertising() }
