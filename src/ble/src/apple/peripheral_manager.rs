...
use crate::apple::converter::{IntoBool, IntoCBUUID};
use crate::apple::events::{peripheral_manager_did_add_service_error, peripheral_manager_did_receive_read_request, peripheral_manager_did_receive_write_requests, peripheral_manager_did_start_advertising_error};
use crate::apple::ffi::{CBAttributePermissions, CBCharacteristicProperties, dispatch_queue_create, DISPATCH_QUEUE_SERIAL, nil};
...
impl PeripheralManager {
    ...
    pub fn stop_advertising(self: &Self) {
        unsafe {
            ...
            let _: Result<(), ()> = msg_send![peripheral_manager, removeAllServices];
        }
    }
